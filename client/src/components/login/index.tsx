...
const Login = ({
  ...
  const { email, password, handleSubmit, handleInputChange, error, handlePlanetClick, handleAnimationEnd, wobble } = useLogin();

  return (
    <div className='container'>
      <div className='left-content'>
        <img src={starImage}alt="Planet"
        className={`spinning-star ${wobble === 1 ? 'wobble' : ''}`}
