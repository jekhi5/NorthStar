 ...
 * - `views`: An array of uids that have viewed the question.
 * - `upVotes`: An array of uids that have upvoted the question.
 * - `downVotes`: An array of uids that have downvoted the question.
